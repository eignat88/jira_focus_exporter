...
Variable supplied by PowerShell:
    :output_dir
...
Important:
    RECID quality checks perform a read-only full scan of raw_ax.purchtable.
*/

\echo [1/14] Table existence
\o :output_dir/table_existence.csv
SELECT
...
\o :output_dir/pg_stat_activity.csv
SELECT
    pid,
    usename,
    application_name,
